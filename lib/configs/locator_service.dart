...
Future<void> init() async {
  // BLOC / Cubit
  sl.registerFactory(() => AuthCubit(signInWithEmailAndPasswordUseCase: sl(), getUserDataFromCacheUseCase: sl()));
  ...
  sl.registerLazySingleton<AuthRepository>(() => AuthRepositoryImpl(authRemoteDataSource: sl(), authLocalDataSource: sl()));
  sl.registerLazySingleton<AuctionRepository>(() => AuctionRepositoryImpl(auctionRemoteDataSource: sl()));
