...
import 'package:auction_mobile/features/domain/repositories/auth_repository.dart';
import 'package:auction_mobile/features/domain/use_cases/sign_in_use_case.dart';
import 'package:auction_mobile/features/domain/value_objects/email.dart';
import 'package:auction_mobile/features/domain/value_objects/password.dart';
...
void main() {
  ...
  const tAuthUser = AuthUser(uuid: '123', email: 'test@test.com', givenName: 'Test', surname: 'User');
